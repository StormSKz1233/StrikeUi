...
function StrikePaid:Window(text,maincolor)
   ...
   UserName.Text = "Strike Hub"
   UserTag.Text = "Name : " ..game.Players.LocalPlayer.Name
   ...
   function StrikePaid:Notification(titletext, desctext, btntext)
